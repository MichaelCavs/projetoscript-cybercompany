...
<body>
<h1>Atendimento Para Computador</h1>
<?php
...
if (!$empty_input) {
$query_usuario = "INSERT INTO computador (nome, email, numero1, contato) VALUES (:nome, :email, :numero1, :contato) ";
...
<option value="Problema Com o Cooler"> Problema Com o Cooler</option>
...
<option value="Problema Relacionado A Placa De Video"> Problema Relacionado A Placa De Video</option>
<option value="Problema na Placa De Rede"> Problema na Placa De Rede</option>
